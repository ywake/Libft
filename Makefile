...
#    Updated: 2020/12/04 04:36:29 by ywake            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS	:= ft_lstnew.c ft_lstadd_front.c ft_lstsize.c ft_lstlast.c ft_lstadd_back.c ft_lstdelone.c ft_lstclear.c ft_lstiter.c ft_lstmap.c ft_strmap_bool_bonus.c ft_strcount_bonus.c ft_strndup_bonus.c free_set_bonus.c ft_strchr_i_bonus.c ft_lst_at_bonus.c ft_lst_reverse_bonus.c ft_lst_merge_bonus.c ft_lst_sort_bonus.c
OBJ		:= $(SRC:%.c=%.o)
OBJBONUS:= $(BONUS:%.c=%.o)
